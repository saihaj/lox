...
public class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
	...
	@Override
	/**
	 * Lox is an imperative language, and mutation comes with the territory.
	 */
	...
	/**
	 * @implNote Lox follows Ruby’s simple rule: false and nil are falsey, and
	 *           everything else is truthy. We implement that like so:
	 */
	...
	private String stringify(Object object) {
		// Lox nil we represent using Java’s null
		if (object == null) {
			return "nil";
		}
